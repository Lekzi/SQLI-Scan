...
(______/ \____)_____|_| |_|_| |_|_____)_|   
 \033[1;36;40m
[+] Made by Lêkzï
[+] Sqli-Scanner is a python tool for scanning websites for SQLI vulnerabilities
[+] Don't forget to follow me on GitHub                                         """)
banner()    
print("""\033[1;32m \033[01m
  [1] Scan a Website 
  [2] Scan more than a Websites
  [3] About tool
  [4] Author
  [5] Exit 
""") 
...
(______/ \____)_____|_| |_|_| |_|_____)_|   
 \033[1;36;40m
[✓] Made by Lêkzï
[✓] N.B: The link must be with Query and it's parameters e.g http://site.com/gallery.php?id=1
""")
...
(______/ \____)_____|_| |_|_| |_|_____)_|   
 \033[1;36;40m
[✓] Made by Lêkzï
[✓] N.B: Save all links in a text file then input the link to the file 
""")
...
Sqli-Scanner is a python tool for scanning websites for SQLI vulnerabilities
	...
	[+]Usage:
Enter the full link (with query and parameters e.g http://site.com/gallery.php?id=1) of the website you want to scan then wait for the tool to scan (+_+) """)
elif check == 4:
	os.system("clear")
	print(""" \033[1;34;40m \033[01m
  ______       _  _                          
...
[+] Made by Lêkzï
[+] N.B
: The link must be with Query and it's parameters e.g http://site.com/gallery.php?id=1
""")
	print("""
[1] Facebook
[2] Follow me on GitHub 
	...
	if pick == 1:
	 os.system("xdg-open https://www.facebook.com/profile.php?id=100068490510296")
	elif pick == 2:
	   	os.system("xdg-open https://github.com/Lekzi")
elif check == 5:
	sys.exit()
else:
